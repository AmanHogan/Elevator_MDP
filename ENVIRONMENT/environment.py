    ...
    def reward_func(self, state, action, new_state):
        ...
        if action_A[0] == 'UP' or action_A[0] == 'DOWN':
            ...
            if n_p1_loc == IN_A:
                ...
                if abs(n_a_floor - n_p1_exit) < abs(a_floor - p1_exit):
                    reward += MOVEMENT_REWARD  * self.elev_a_passengers
                else:  
                    reward -= MOVEMENT_PENALTY * self.elev_a_passengers
        ...
        if action_B[0] == 'UP' or action_B[0] == 'DOWN':
            ...
            if n_p1_loc == IN_B:
                ...
                if abs(n_b_floor - n_p1_exit) < abs(b_floor - p1_exit):
                    reward += MOVEMENT_REWARD * self.elev_b_passengers
                else:  
                    reward -= MOVEMENT_PENALTY * self.elev_b_passengers
        ...
        if action_A[0] == 'DOORS':
            ...
            if p1_loc == IN_A and n_p1_loc == WAITING:
                reward += PASSENGER_DROP_OFF_REWARD * self.elev_a_passengers
        ...
        if action_B[0] == 'DOORS':
            ...
            if p1_loc == IN_B and n_p1_loc == WAITING:
                reward += PASSENGER_DROP_OFF_REWARD * self.elev_b_passengers
